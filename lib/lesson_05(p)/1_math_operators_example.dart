void main() {
  ...
  final integerDivision = 12 ~/ 5; // Цілочисельне ділення (без остачі)
  final remainder = 12 % 5; // Остача від ділення
  // 5 * 2 = 10    12 - 10 = 2
  ...
  // i++ — спочатку використовує старе значення, потім збільшує
  // ++i — спочатку збільшує, потім використовує;
  // Приклад freezedCounter
}
