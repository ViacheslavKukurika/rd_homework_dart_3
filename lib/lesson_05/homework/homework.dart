...
void task6() {
  ...
  // Спробую використати тернарний оператор для цього виразу

  final result = examScore > 90
      ? 'Відмінно'
      : examScore >= 75
          ? 'Добре'
          : examScore >= 60
              ...
              : examScore >= 20
                  ...
                  : 'Повторити курс';
  print('''
Оцінка (тернарний оператор): $result
''');
  print('-----------------Завдання 7-----------------');
}
...
void task7() {
  ...
  final nameOfTheDay = switch (dayNumber) {
    1 => 'Понеділок',
    2 => 'Вівторок',
    3 => 'Середа',
    4 => 'Четвер',
    5 => "П'ятниця",
    6 => 'Вихідний день 🎉 - Субота',
    7 => 'Вихідний день 🎉 - Неділя',
...
void task8() {
  ...
  print('Наступний цикл (виводить лише парні числа):');

  for (var i = 1; i < 11; i++) {
    if (i % 2 == 0) print(i);
  }
  print('Сума чисел від 1 до 10:');
